...
namespace WirtualnaUczelnia.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly ApplicationDbContext _context; // Dodajemy kontekst bazy
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Poruszam siê na wózku (unikaj schodów)")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // Zapisujemy preferencje u¿ytkownika
